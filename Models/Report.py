...
class Report:
    ...
    def load_players(self):
        """
        Charge la liste des joueurs depuis le fichier players.json. En cas d'erreur (fichier introuvable
        ou erreur de décodage JSON), un message d'erreur est affiché.
